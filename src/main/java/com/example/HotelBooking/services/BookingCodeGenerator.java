...
public class BookingCodeGenerator {
    ...
    public String generateBookingReference()
    {
        ...
        }while(isBookingReferenceExist(bookingReference)); //check if the code already exist, if it doesn't exist

        saveBookingReferenceToDatabase(bookingReference); //save the code to DB
