...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public Response getAlBookings() {
        List<Booking> bookingList = bookingRepository.findAll(Sort.by(Sort.Direction.DESC, "id"));
        List<BookingDTO> bookingDTOList = modelMapper.map(bookingList, new TypeToken<List<BookingDTO>>() {}.getType());

        for(BookingDTO bookingDTO : bookingDTOList)
        {
            bookingDTO.setUser(null); //don't need these information to display
            bookingDTO.setRoom(null); //don't need these information to display
        }
    ...
    public Response createBooking(BookingDTO bookingDTO) {
        ...
        //calculate the total price needed for the stay
        ...
        bookingRepository.save(booking); //save to DB

        //generate the payment which will be sent through mail
        ...
        NotificationDTO notificationDTO = NotificationDTO.builder()
                ...
                .body(String.format("Your booking has been create successfully. Please proceed with your payment using hte payment link below" +
                        "\n%s", paymentUrl))
    ...
    public Response updateBooking(BookingDTO bookingDTO) {
        ...
        Booking existingBooking = bookingRepository.findById(Math.toIntExact(bookingDTO.getId()))
